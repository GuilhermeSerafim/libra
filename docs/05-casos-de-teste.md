...
| TC-003 | Parametrizado | RF-01 | UC-01 | Validar combinacoes invalidas de nome, email e senha. | Sistema rejeita cada combinacao invalida e apresenta validacao adequada. |
...
| TC-006 | Parametrizado | RF-02 | UC-02 | Validar campos vazios e email malformado no login. | Sistema bloqueia envio ou recusa autenticacao com mensagem de validacao. |
...
| Parametrizado | Repeticao do mesmo teste com diferentes massas de dados. | TC-003 cobre combinacoes invalidas de cadastro e TC-006 cobre entradas invalidas de login. |
